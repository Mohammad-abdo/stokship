...
const EditShippingCompany = () => {
  ...
  const fetchCompany = async () => {
    try {
      ...
      showToast.error(t('shippingCompanies.edit.loadFailed'), error.response?.data?.message || t('shippingCompanies.edit.loadFailedDesc'));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await adminApi.updateShippingCompany(id, formData);
      showToast.success(t('shippingCompanies.edit.updatedSuccess'), t('shippingCompanies.edit.updatedSuccessDesc'));
      navigate('/stockship/admin/shipping-companies');
    } catch (error) {
      console.error('Error updating shipping company:', error);
      showToast.error(t('shippingCompanies.edit.updateFailed'), error.response?.data?.message || t('shippingCompanies.edit.updateFailedDesc'));
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">{t('shippingCompanies.edit.loading')}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">{t('shippingCompanies.edit.title')}</h1>
          <p className="text-gray-600 mt-2">{t('shippingCompanies.edit.subtitle')}</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative inline-block">
                  ...
                  <div className="absolute top-2 right-2 flex gap-2">
                    <button
                      ...
                      title={t('shippingCompanies.create.changeAvatar') || 'Change Avatar'}
                    >
                      <Upload className="w-4 h-4" />
                    </button>
                    <button
                      ...
                      title={t('shippingCompanies.create.removeAvatar') || 'Remove Avatar'}
                    >
                      <X className="w-4 h-4" />
                    </button>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  <option value="ACTIVE">{t('shippingCompanies.active') || 'Active'}</option>
                  <option value="INACTIVE">{t('shippingCompanies.inactive') || 'Inactive'}</option>
                </select>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-4 pt-4 border-t">
              ...
              >
                ...
                {loading ? t('shippingCompanies.edit.updating') : t('shippingCompanies.edit.updateCompany')}
              </motion.button>
            </div>
          </form>
        </CardContent>
