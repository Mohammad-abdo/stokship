...
import { offerSupportTicketApi, offerApi } from '@/lib/mediationApi';
...
const CreateOfferSupportTicket = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setSubmitting(true);
      await offerSupportTicketApi.createTicket(offerId, {
      ...
      navigate(`/stockship/trader/offers/${offerId}`);
    } catch (error) {
    ...
    >
      ...
      <div className={`flex items-center gap-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          onClick={() => navigate(`/stockship/trader/offers/${offerId}`)}
        ...
        <div className={isRTL ? 'text-right' : 'text-left'}>
          ...
          <p className="text-muted-foreground mt-2">
            {t('mediation.support.createTicketDesc') || 'Create a support ticket for this offer'}
          </p>
        </div>
      </div>
              ...
              <div className={`flex items-start gap-3 ${isRTL ? 'flex-row-reverse' : ''}`}>
                ...
                <div className={isRTL ? 'text-right' : 'text-left'}>
                  ...
                  <p className="text-sm text-blue-800">
                    {t('mediation.support.ticketInfoDesc') || 'Support tickets allow you to communicate with employees about issues related to this offer. Your assigned employee will respond to your ticket.'}
                  </p>
                </div>
              </div>
            </CardContent>
